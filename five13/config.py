...
lr_ = [(1200, 1e-3), (4000, 2e-4), (8000, 4e-5), (100000000, 2e-6)]
discount = None  # 折扣系数，None就是没有折扣
ckpt_path = "ckpt"
total_step = 4000
tau_decay_rate = 0.82  # 温度衰减项，越往后温度应该越低
# 噪声项
noise_eps = 0.25
final_eps = 0.1
...
init_temp = 2.0  # 初始温度  # 温度越大分布越平缓，这里适当调大，主要是考虑到初始分布太尖锐了
search_threads = 4  # 4个线程异步搜索
virtual_loss = 5
