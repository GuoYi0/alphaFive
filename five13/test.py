...
# exculator = ThreadPoolExecutor(max_workers=4)
#
# a = 0
#
# all_done = Lock()
...
#
# for i in range(4):
#     exculator.submit(add)
#     all_done.acquire(True)
# all_done.release()
# exculator.shutdown(False)
# exculator._threads.clear()
#
# print(a)
