...
class Player(object):
    def __init__(self, cfg=None, training=True, pv_fn=None, use_net=True, q_metric=False):
        ...
        # self.visited_states = defaultdict(list)  # key是state,value是list，里面装的action
    ...
    def calc_policy(self, state, e):
        ...
        # idx = np.argsort(policy_valid)[-10:]
        # for i in idx:
        #     print(candidate_actions[i], node.a[candidate_actions[i]].n)
