...
from genData.self_play_win import SelfPlayWorker
...
def main(restore=False):
    ...
    while step < config.total_step:
        ...
        print("black: white = {}: {} in the memory".format(stack.black_win, stack.white_win))
