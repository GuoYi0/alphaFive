...
class RandomStack(object):
    ...
    def save(self):
        np.save("data_buffer/data.npy", self.data)
        np.save("data_buffer/data_len.npy", self.data_len)
        np.save("data_buffer/result.npy", self.result)

    def load(self):
        self.data = np.load("data_buffer/data.npy")
        self.data_len = np.load("data_buffer/data_len.npy")
        self.result = np.load("data_buffer/result.npy")
